...
PATH_TO_FIXED_POINT_FINDER = '/Users/hansem/Dropbox (MIT)/MPong/phys/code/' # '/om/user/rishir/lib/PongRnn/'
sys.path.insert(0, PATH_TO_FIXED_POINT_FINDER)
from phys.code.rnn_analysis import utils, data_utils

PATH_ = '/Users/hansem/Dropbox (MIT)/MPong/phys/code/rnn_analysis/scripts/'  # '/om/user/rishir/lib/PongRnn/rnn_analysis/run_scripts/'
