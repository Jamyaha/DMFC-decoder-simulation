...
# kilsort 3
#echo "addpath (\"/om/user/rishir/lib/Kilosort/\"); EntryPoint_vprobe64(\"$@\"); exit;" > $tmp_fn.m


echo "addpath (\"/om/user/rishir/lib/Kilosort/\");" > $tmp_fn.m
echo "EntryPoint_vprobe64(\"$@\", 1);" >> $tmp_fn.m
echo "EntryPoint_vprobe64(\"$@\", 2);" >> $tmp_fn.m
echo "EntryPoint_vprobe64(\"$@\", 3);" >> $tmp_fn.m
echo "EntryPoint_vprobe64(\"$@\", 4);" >> $tmp_fn.m
echo "exit;" >> $tmp_fn.m
